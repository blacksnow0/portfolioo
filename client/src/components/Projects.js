        ...
        <div className="relative group">
          <div className="overflow-hidden rounded-lg shadow-lg">
            <img
              src={project4}
              alt="Project 4"
              className="w-full h-48 object-center transition-transform duration-300 group-hover:scale-105"
            />
          </div>
          <div className="absolute inset-0 rounded-lg bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-center items-center">
            <h3 className="text-2xl font-semibold text-offWhite drop-shadow-xl">
              RoadWays
            </h3>

            <a
              href="https://roadways-drab.vercel.app/"
              target="_blank"
              rel="noreferrer"
